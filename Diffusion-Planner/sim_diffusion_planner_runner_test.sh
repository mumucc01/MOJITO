...
export NUPLAN_DATA_ROOT="/lpai/volumes/base-3da-ali-sh-mix/zhangxc/DiffusionPlanner/test_db_has_sensor/"
...
ARGS_FILE=/lpai/volumes/base-3da-ali-sh-mix/chengzhijing/DiffusionPlanner_v10/Diffusion-Planner/training_log/v36/2025-11-13-02:40:40/args.json
...
CKPT_FILE=/lpai/volumes/base-3da-ali-sh-mix/chengzhijing/DiffusionPlanner_v10/Diffusion-Planner/training_log/v36/2025-11-13-02:40:40/model_epoch_100_trainloss_0.0092.pth
if [ "$SPLIT" == "val14" ]; then
    SCENARIO_BUILDER="nuplan"   #SCENARIO_BUILDER="nuplan_mini"
else
