...
pluto_utils_path = "/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/AD-Eccv/DiffusionPlanner_v37/pluto-main/src"
if pluto_utils_path in sys.path:
    sys.path.remove(pluto_utils_path)

sys.path.insert(0, pluto_utils_path)
from utils.utils import to_device, to_numpy, to_tensor
sys.path.remove(pluto_utils_path)
