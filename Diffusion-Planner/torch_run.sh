...
###################################
RUN_PYTHON_PATH="/lpai/volumes/base-3da-ali-sh-mix/chengzhijing/conda_env/diffusion_planner_mix/bin/python" # python path (e.g., "/home/xxx/anaconda3/envs/diffusion_planner/bin/python")
...
#TRAIN_SET_PATH="/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/nuplan-dataset-img-lidar-current-100w/npz_data" # preprocess data using data_process.sh
#TRAIN_SET_LIST_PATH="/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/nuplan-dataset-img-lidar-current-100w/train_test_1112.json"
###################################
