...
import sys
import sys
sys.path.append('/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/AD-Eccv/DiffusionPlanner_v37/pluto-main/src')
...
RESULT_FOLDER = "/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/AD-Eccv/DiffusionPlanner_v37/Diffusion-Planner/exp/simulation/closed_loop_reactive_agents/diffusion_planner/val14/diffusion_planner_release/model_epoch_370_trainloss_0.0038_2025-12-11-16-47-24"
env_variables = {
    "NUPLAN_DEVKIT_ROOT": "/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/AD-Eccv/DiffusionPlanner_v37/nuplan-devkit-master",  # nuplan-devkit absolute path (e.g., "/home/user/nuplan-devkit")
    ...
    "NUPLAN_EXP_ROOT": "/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/AD-Eccv/DiffusionPlanner_v37/Diffusion-Planner/exp", # nuplan experiment absolute path (e.g. "/data/nuplan-v1.1/exp")
