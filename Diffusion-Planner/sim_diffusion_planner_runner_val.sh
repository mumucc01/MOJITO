...
export NUPLAN_DATA_ROOT="/lpai/volumes/base-3da-ali-sh-mix/zhangxc/DiffusionPlanner/val_db/"
...
ARGS_FILE=/lpai/volumes/base-3da-ali-sh-mix/chengzhijing/DiffusionPlanner_v10/Diffusion-Planner/training_log/v36/2025-11-11-17:38:51/args.json
...
CKPT_FILE=/lpai/volumes/base-3da-ali-sh-mix/chengzhijing/DiffusionPlanner_v10/Diffusion-Planner/training_log/v36/2025-11-11-17:38:51/model_epoch_400_trainloss_0.0054.pth
if [ "$SPLIT" == "val14" ]; then
