...
cd /mnt/volumes/base-3da-ali-sh-mix/chengzhijing/AD-Eccv/DiffusionPlanner_v37
# User Configuration Section
###################################
# Set environment variables
export NUPLAN_DEVKIT_ROOT="/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/AD-Eccv/DiffusionPlanner_v37/nuplan-devkit-master"  # nuplan-devkit absolute path (e.g., "/home/user/nuplan-devkit")
...
export NUPLAN_EXP_ROOT= "/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/AD-Eccv/DiffusionPlanner_v37/Diffusion-Planner/exp" # nuplan experiment absolute path (e.g. "/data/nuplan-v1.1/exp")
...
ARGS_FILE=/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/AD-Eccv/DiffusionPlanner_v37/Diffusion-Planner/training_log/v38/2025-12-12-00:16:58/args.json
...
CKPT_FILE=/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/AD-Eccv/DiffusionPlanner_v37/Diffusion-Planner/training_log/v38/2025-12-12-00:16:58/model_epoch_240_trainloss_0.0054.pth
if [ "$SPLIT" == "val14" ]; then
...
export PYTHONPATH="/mnt/volumes/base-3da-ali-sh-mix/chengzhijing/AD-Eccv/DiffusionPlanner_v37/Diffusion-Planner:$PYTHONPATH"
...
/lpai/volumes/base-3da-ali-sh-mix/chengzhijing/conda_env/diffusion_planner_mix/bin/python $NUPLAN_DEVKIT_ROOT/nuplan/planning/script/run_simulation.py \
