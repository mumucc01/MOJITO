...
def get_trajectory_as_array(
    ...
    future_sampling: TrajectorySampling, # 40,1,0.1
...
def pdm_score(
    ...
    pdm_states, pred_states = ( #future_sampling: TrajectorySampling(num_poses=40, time_horizon=4.0, interval_length=0.1)
