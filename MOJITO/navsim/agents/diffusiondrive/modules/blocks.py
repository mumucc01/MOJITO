...
class GridSampleCrossBEVAttention(nn.Module):
    ...
    def forward(self, queries, traj_points, bev_feature, spatial_shape):
        """
        Args:
            queries: input features with shape of (bs, num_queries, embed_dims) [B,20,256]
            traj_points: trajectory points with shape of (bs, num_queries, num_points, 2) [B,20,8,2]
