...
class TransfuserBackbone(nn.Module):
    ...
    def __init__(self, config: TransfuserConfig):
        ...
        self.fusion_dim = 512
        adapter_dims = (self.fusion_dim, self.fusion_dim, self.fusion_dim, self.fusion_dim)

        self.image_encoder = DINOv3Backbone(
            model_name='dinov3_vits16plus',
            weights_path=dinov3_pretrain,
            patch_size=16,
            out_indices=None,
            out_channels=adapter_dims,   
            freeze=True,
        )
        ...
        self.lidar_encoder = DINOv3Backbone(
            model_name='dinov3_vits16plus',
            weights_path=config.dinov3_pretrain,
            patch_size=16,
            out_indices=None,
            out_channels=adapter_dims,   
            freeze=False,
