...
from navsim.mojito_paths import checkpoint_path, pretrained_path
...
class TransfuserConfig:
    ...
    bkb_path: str = pretrained_path("resnet34.a1_in1k", "model.safetensors")
    plan_anchor_path: str = pretrained_path("kmeans_navsim_traj_20.npy")
    diffusion_drive_checkpoint_path: Optional[str] = checkpoint_path("diffusiondrive_navsim_88p1_PDMS")
    uni3d_checkpoint_path: str = pretrained_path("uni3d_b.pt")
    ...
    lidar_min_x: float = -16
    lidar_max_x: float = 16
    lidar_min_y: float = 0
