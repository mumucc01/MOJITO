...
def main(cfg: DictConfig) -> None:
    ...
    scene_filter: SceneFilter = instantiate(cfg.train_test_split.scene_filter)
    data_path = Path(cfg.navsim_log_path) #/Diffusion_Drive/DiffusionDrive/dataset/navsim_logs/trainval
    sensor_blobs_path = Path(cfg.sensor_blobs_path) #/Diffusion_Drive/DiffusionDrive/dataset/sensor_blobs/trainval
    scene_loader = SceneLoader(
