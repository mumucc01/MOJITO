...
def main(cfg: DictConfig) -> None:
    ...
    if cfg.use_cache_without_dataset:
        ...
        cfg.train_logs = cfg.train_logs[:2]
      
        cfg.val_logs =  cfg.val_logs[:15]
    ...
    trainer.fit(    #/Diffusion_Drive/DiffusionDrive/navsim/planning/training/agent_lightning_module.py P27
